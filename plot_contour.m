...
sigma_pr_values = 0:0.5:10;  % sigma_pr의 변화 범위
sigma_range_values = 0:0.5:5;  % sigma_range의 변화 범위
...
subplot(1, 2, 1);
contour(sigma_pr_values, sigma_range_values, kf_error, 'LevelStep', 0.2, 'ShowText', 'on');  % 등고선 간격을 0.1로 설정
colorbar;
