...
%% 시뮬레이션 데이터 추출
num_iterations = 2000; % 시간 단계 수
convergence_idx = 1800; % Plot 시작 시간
...
%% Kalman Filter 정의
kalman_filter = TC_ABS_KF(init_x, P);
...
for k = 1:num_iterations
    ...
    kalman_filter = kalman_filter.correct(gps_pos_k, z_abs, R);
    
    % 추정된 상태 저장
    ls_position(:, k) = ref_pos;
