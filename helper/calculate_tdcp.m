function tdcp_vec = calculate_tdcp(prev_pos, curr_pos, prev_carrier, prev_gps_pos, curr_carrier, curr_gps_pos)
    ...
    for k = 1:num_sv
        ...
        g_motion = (los_curr' * prev_pos) - (los_prev' * prev_pos);
        ...
        tdcp_vec(k) = lambda * tdcp_measured;
    end
end
