...
function [kf_error_vec, ls_error_vec, kf_error_with_pr_vec] = main_abs_rel_range_for_ipnt(sigma_pr, sigma_range, r_sigma_pr, r_sigma_range, folder_path, visable)
    addpath('./module');
    addpath('./helper');
    ...
    for i = sigma_value
        ...
        for k = 1:num_iterations
            ...
            estimated_states(:, k, sigma_idx) = kalman_filter.state';
    ...
    fprintf('Final RMS error (KF without range) in 3D: %.4f meters\n', sqrt(mean(error_3d_with_pr.^2)));
